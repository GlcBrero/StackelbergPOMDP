#!/bin/bash
#SBATCH --job-name=mspm_mw300
#SBATCH --partition=cpu
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --time=2-00:00:00
#SBATCH --array=0-3
#SBATCH --output=results/mspm_mw_300_response_sweep/slurm_%A_%a.out
#SBATCH --error=results/mspm_mw_300_response_sweep/slurm_%A_%a.err
...
mkdir -p results/mspm_mw_300_response_sweep

epsilons=(0.02 0.05 0.10 0.20)

mw_epsilon="${epsilons[$SLURM_ARRAY_TASK_ID]}"
