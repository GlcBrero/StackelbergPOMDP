...
e2_prepare_runtime
export MPLCONFIGDIR=/private/tmp/mpl-stackpomdp-e2-threshold-residual-v2-buyer-training
...
"$PYTHON" -u -m replication.atari.train_atari_stackpomdp_leader_sb3 \
  ...
  --wandb-job-type atari_e2_direct_threshold_residual_v3_buyer_leader \
