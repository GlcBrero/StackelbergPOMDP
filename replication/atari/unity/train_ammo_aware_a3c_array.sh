#!/bin/bash
#SBATCH --job-name=atari_a3c_ammo
#SBATCH --partition=cpu
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=04:00:00
#SBATCH --array=1-3
#SBATCH --output=replication/atari/unity_logs/ammo_aware_a3c_%A_%a.out
#SBATCH --error=replication/atari/unity_logs/ammo_aware_a3c_%A_%a.err
...
checkpoint="replication/atari/checkpoints/unity/space_invaders_5bullets_a3c_ammo_mask_seed${seed}_2m.pkl"
...
python -u -m replication.atari.train_five_bullet_gameplay \
    ...
    --wandb-name "five_bullet_a3c_ammo_mask_seed${seed}_2m_unity"
