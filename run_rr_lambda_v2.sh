#!/bin/bash
#SBATCH --job-name=rr_lv2
#SBATCH --partition=cpu
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --time=2-00:00:00
#SBATCH --output=results/rr_lambda_v2/slurm_%A_%a.out
#SBATCH --error=results/rr_lambda_v2/slurm_%A_%a.err
#SBATCH --array=1-40
...
echo "RoundRobin v2 (critic obs fix) Lambda=$LAMBDA, Obs=$OBS, Seed=$SEED"
