#!/bin/bash
#SBATCH --job-name=rr_lam
#SBATCH --partition=cpu
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --time=1-00:00:00
#SBATCH --output=results/rr_lambda/slurm_%A_%a.out
#SBATCH --error=results/rr_lambda/slurm_%A_%a.err
#SBATCH --array=1-40
...
echo "RoundRobin Lambda=$LAMBDA, Obs=$OBS, Seed=$SEED"
