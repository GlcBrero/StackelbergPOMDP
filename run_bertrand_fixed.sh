#!/bin/bash
#SBATCH --job-name=bert_fix
#SBATCH --partition=cpu
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --time=2-00:00:00
#SBATCH --output=results/bertrand_fixed/slurm_%A_%a.out
#SBATCH --error=results/bertrand_fixed/slurm_%A_%a.err
#SBATCH --array=1-6
...
# 6 configurations: (algorithm) x (seed)
# 1-3: A2C seeds 1-3
# 4-6: PPO seeds 1-3
...
echo "Config: alg=${ALG}, seed=${SEED}, demand bug fixed, ent_coef=0.01"
