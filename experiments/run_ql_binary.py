"""Binary threshold ablation: open/close action space with optional sorting.

Usage: python run_ql_binary.py <seed> <obs_type> <sort_obs>
  obs_type: price_profile | no_observation
  sort_obs: sorted | unsorted
"""
import sys, os
