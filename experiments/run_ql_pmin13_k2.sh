#!/bin/bash
#SBATCH --job-name=ql_k2
#SBATCH --partition=cpu
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --time=2-00:00:00
#SBATCH --output=results/ql_pmin13_k2/slurm_%A_%a.out
#SBATCH --error=results/ql_pmin13_k2/slurm_%A_%a.err
#SBATCH --array=0-49
...
echo "Job $IDX: seed=$SEED, lambda=$LAM, obs=$OBS, leader_k=2"
python experiments/run_ql_pmin13_k2.py $SEED $LAM $OBS
