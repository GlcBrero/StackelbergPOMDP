#!/bin/bash
#SBATCH --job-name=minint
#SBATCH --partition=cpu
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --time=2-00:00:00
#SBATCH --output=results/minimal_intervention/slurm_%A_%a.out
#SBATCH --error=results/minimal_intervention/slurm_%A_%a.err
#SBATCH --array=1-50
...
# Decode array task ID into (lambda_idx, obs_type, seed)
