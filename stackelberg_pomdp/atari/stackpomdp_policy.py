...
New code should import :mod:`stackelberg_pomdp.policies.atari`.
...
from stackelberg_pomdp.policies.atari import *  # noqa: F401,F403
from stackelberg_pomdp.policies.atari import __all__
