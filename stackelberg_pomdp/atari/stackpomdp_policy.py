...
New code should import :mod:`stackelberg_pomdp.atari.policies.composite`.
...
from stackelberg_pomdp.atari.policies.composite import *  # noqa: F401,F403
from stackelberg_pomdp.atari.policies.composite import __all__
