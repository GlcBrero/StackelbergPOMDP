...
from stackelberg_pomdp.calvano import (
    PAPER_INTERVENTION_CALVANO,
    average_symmetric_gain_index,
)

ALPHA = PAPER_INTERVENTION_CALVANO.alpha
BETA = PAPER_INTERVENTION_CALVANO.beta
DELTA = PAPER_INTERVENTION_CALVANO.discount
EVAL_STEPS = 250000
...
def eval_model(model_path, config):
    ...
    from stackelberg_pomdp.baselines_utils import CustomA2C, CustomPolicy
    try:
        from .env_setups import get_bertrand_env
    except ImportError:
        from env_setups import get_bertrand_env
