"""
Replicate Calvano et al. (2019) Figure 4: deviation and punishment experiment.

Loads converged Q-tables from calvano_replication.py output, then:
...
import numpy as np
from stackelberg_pomdp.calvano import DEFAULT_CALVANO
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', type=str, required=True,
                        help='Directory with saved Q-tables from calvano_replication.py')
    ...
    print(f"Calvano deviation experiment: m={m}, {len(states)} converged sessions")
