#!/bin/bash
#SBATCH --job-name=rr_m4
#SBATCH --partition=cpu
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --time=1-00:00:00
#SBATCH --output=results/roundrobin_m4/slurm_%A_%a.out
#SBATCH --error=results/roundrobin_m4/slurm_%A_%a.err
#SBATCH --array=1-10
...
echo "RoundRobin, m=4, Obs=$OBS, Seed=$SEED"
