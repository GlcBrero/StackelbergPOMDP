#!/bin/bash
#SBATCH --job-name=int250k
#SBATCH --partition=cpu
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --time=2-00:00:00
#SBATCH --output=results/intervention_250k/slurm_%A_%a.out
#SBATCH --error=results/intervention_250k/slurm_%A_%a.err
#SBATCH --array=1-10
