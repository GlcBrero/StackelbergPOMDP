#!/bin/bash
#SBATCH --job-name=rr_ppo
#SBATCH --partition=cpu
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --time=1-00:00:00
#SBATCH --output=results/roundrobin_ppo/slurm_%A_%a.out
#SBATCH --error=results/roundrobin_ppo/slurm_%A_%a.err
#SBATCH --array=1-10
...
echo "RoundRobin PPO, m=5, Obs=$OBS, Seed=$SEED"
